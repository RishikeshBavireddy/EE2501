...
set title "power delivered v/s load-resistance plot of solar cell under Illumination" font ",18"
set xlabel "Load Resistance (Ohms)" font ",14"
set ylabel  "Power delivered to the load resistance (mW)" font ",14"
...
plot "pr.dat" using 1:2 with points ls 1 title "Measured Data", \
     "pr.dat" using 1:2 with lines ls 2 title "Interpolated Curve"
