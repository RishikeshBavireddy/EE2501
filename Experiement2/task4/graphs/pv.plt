...
set title "power delivered v/s voltage across load plot of solar cell under Illumination" font ",18"
set ylabel "Power delivered to the load (mW)" font ",14"
set xlabel "Voltage across load resistance (V)" font ",14"
...
plot "pv.dat" using 2:1 with points ls 1 title "Measured Data", \
     "pv.dat" using 2:1 with lines ls 2 title "Interpolated Curve"
