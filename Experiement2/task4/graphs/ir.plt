...
set title "current v/s load-resistance plot of solar cell under Illumination" font ",18"
set ylabel "Current through R (mA)" font ",14"
set xlabel "Resistance (Ohms)" font ",14"
...
plot "ir.dat" using 2:1 with points ls 1 title "Measured Data", \
     "ir.dat" using 2:1 with lines ls 2 title "Interpolated Curve"
