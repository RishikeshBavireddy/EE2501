...
set output "blight.png"

set title "current v/s voltage plot of solar cell with buffer under illumination" font ",18"
...
plot "lightb.dat" using 1:2 with points ls 1 title "Measured Data", \
     "lightb.dat" using 1:2 with lines ls 2 title "Interpolated Curve"
